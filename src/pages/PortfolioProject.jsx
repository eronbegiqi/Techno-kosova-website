...
const projectData = {
  ...
  'street-party-prishtina-2026': {
    title: 'Street Party Prishtina 2026',
    type: 'Event Coverage',
    year: '2026',
    location: 'Prishtina',
    intro: 'Live recordings and short-form clips from Street Party Prishtina 2026 — DJ sets, highlights, and social clips from La Baresha, Luna Skye, Neritaan and more.',
    videos: [
      { title: 'LA Baresha — Set for Street Party Prishtina', videoId: 'uQ7gmW-LI2s' },
      { title: 'Luna Skye — Paris, Ibiza for Street Party Prishtina', videoId: 'f1aoLEyXdhs' },
      { title: 'Neritaan — Set for Street Party Prishtina 2026', videoId: 'LPebm7sUdpA' },
      { title: 'LA Baresha — Short', videoId: 'm65n4plrDXE' },
      { title: 'LA Baresha — Short', videoId: 'goqqk4J8uqY' },
      { title: 'LA Baresha — Short', videoId: '36LxRNTTydg' },
      { title: 'LA Baresha — Short', videoId: 'KrmvhOYXP54' },
      { title: 'LA Baresha — Short', videoId: '1VcvcZGgzWs' },
      { title: 'LA Baresha — Short', videoId: '6_7SZUmYcmA' },
      { title: 'Neritaan — Short', videoId: '4GKxIT8E4Mw' },
      { title: 'Neritaan — Short', videoId: '5jjyUAo3h70' },
      { title: 'Neritaan — Short', videoId: 'iR4aVbpI8Hc' },
      { title: 'Neritaan — Short', videoId: 'QoDDs2Jg3Vg' },
      { title: 'Neritaan — Short', videoId: 'wTUzEjYTEFg' },
      { title: 'LA Baresha — Short', videoId: 'YFbQ0D7G-io' },
      { title: 'Neritaan — Short', videoId: '6kCGEIVbPjc' },
      { title: 'Luna Skye — Short', videoId: 'BoPX2KzCLM8' },
      { title: 'Luna Skye — Short', videoId: 'c_bYeJZwZq4' },
      { title: 'Luna Skye — Short', videoId: '82rk0TbqW-w' },
      { title: 'Luna Skye — Short', videoId: 'cTxG11L2wVA' },
      { title: 'Luna Skye — Short', videoId: 'COKdN9OIDoc' },
      { title: 'Luna Skye — Short', videoId: 'zGhu0Lhn7AU' },
      { title: 'Luna Skye — Short', videoId: 'NNEbtl1NJyQ' },
      { title: 'Luna Skye — Short', videoId: 'poryl3DE3qs' },
      { title: 'Luna Skye — Short', videoId: 'gPeqVh1HMjs' },
      { title: 'Luna Skye — Short', videoId: 'Fqzv3nmoRPk' },
      { title: 'Luna Skye — Short', videoId: 'ZSwnwoXTsNw' },
      { title: 'LUK — Short', videoId: '3YGNsIF79rA' },
    ],
  },
}
